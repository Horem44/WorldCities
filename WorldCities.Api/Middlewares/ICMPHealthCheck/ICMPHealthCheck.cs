...
namespace WorldCities.Api.Middlewares.ICMPHealthCheck
{
    ...
    {
        public static IHealthChecksBuilder AddICMPHealthCheck(this IHealthChecksBuilder checksBuilder, int ping, string host)
        {
